...
insert into accommodations (id, name, guests, cost) values ('ba3bb899-6e60-4d18-a2ed-11cca760578f', 'Suíte Luxo com Vista para o Mar', 4, 840.00);
insert into accommodations (id, name, guests, cost) values ('c9c3b5a3-8e6f-4f1d-a63f-3fb35c3ff813', 'Suíte Presidencial', 2, 1500.00);
insert into accommodations (id, name, guests, cost) values ('f14fda3a-ae5f-4645-9db8-6cfbce09c695', 'Suíte Executiva', 3, 1200.00);
insert into accommodations (id, name, guests, cost) values ('de8c0a3b-0cc8-4de4-a028-9da5a5690c64', 'Suíte Deluxe com Piscina Privativa', 2, 1300.00);
insert into accommodations (id, name, guests, cost) values ('6d86e35f-2960-4eb3-8a87-5a19d75a03a8', 'Quarto Superior Vista Montanha', 2, 1100.00);
insert into accommodations (id, name, guests, cost) values ('b58699e0-9a57-4eb5-841a-6e4746dbaa19', 'Quarto Duplo Standard', 2, 950.00);
insert into accommodations (id, name, guests, cost) values ('76a6a08e-10f7-4874-8419-2246a84bb314', 'Quarto King com Varanda', 2, 1400.00);
insert into accommodations (id, name, guests, cost) values ('e62ff3ef-b7f8-44a6-b7a0-b046dcd2e331', 'Suíte Júnior com Vista para o Mar', 3, 1600.00);
insert into accommodations (id, name, guests, cost) values ('1238328f-24ad-4e6a-b3ec-440c67a7a2f8', 'Quarto Standard Família', 2, 800.00);
insert into accommodations (id, name, guests, cost) values ('27f3de5d-41b2-4981-9138-df7c6d51d4b1', 'Suíte Premier com Hidromassagem', 2, 1350.00);
