package com.fiap.hackathon.client.service;
...
public class ClientService {
    ...
    public ClientEntity registerClient(ClientRequestDTO clientRequestDTO) {
        ...
        if (clientRepository.existsByPassport(clientRequestDTO.passport()))
            throw new DataIntegrityViolationException("passport already registered");
